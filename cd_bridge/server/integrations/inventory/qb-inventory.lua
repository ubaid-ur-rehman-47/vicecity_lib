...
function RemoveItem(source, item_name, amount, slot)
    return exports['qb-inventory']:RemoveItem(source, item_name, amount, slot)
end
...
function AddQualityToItem(source, slot, qualityIncrease, itemName)
    ...
    exports['qb-inventory']:SetItemData(source, itemName, 'info', metadata, slot)
end
...
function GetItemList()
    -- Rebuild so validation sees items removed since the bridge started.
    ItemList = {}
