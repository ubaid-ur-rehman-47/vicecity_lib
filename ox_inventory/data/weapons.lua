...
return {
	Weapons = {
		...
		['WEAPON_AKAPOCALYPTIC'] = {
			label = 'AK Apocalyptic',
			weight = 4500,
			durability = 0.03,
			permanent = true,
			ammoname = 'ammo-rifle2',
		...
		['at_flashlight'] = {
			...
			client = {
				component = {
					...
					`COMPONENT_AT_M16ROBOT_FLSH`,
					`COMPONENT_AT_M416ELECTRO_FLSH`,
					`COMPONENT_AT_WHITECODE_FLSH`,
				},
				usetime = 2500
			}
		},
		...
		['at_suppressor_heavy'] = {
			...
			client = {
				...
				component = {
					...
					`COMPONENT_AT_AKAPOCALYPTIC_SUPP`,
					`COMPONENT_AT_AKSPIDER_SUPP`,
					`COMPONENT_AT_AR15_SUPP`,
					`COMPONENT_AT_ASHBRINGER_SUPP`,
					`COMPONENT_AT_AVAMP7_SUPP`,
					`COMPONENT_AT_AWPICE_SUPP`,
					`COMPONENT_AT_AZUROK_SUPP`,
					`COMPONENT_AT_BLDRAGON_SUPP`,
					`COMPONENT_AT_DEADFALL_SUPP`,
					`COMPONENT_AT_GLORY_SUPP`,
					`COMPONENT_AT_GUZI_SUPP`,
					`COMPONENT_AT_M14_SUPP`,
					`COMPONENT_AT_M16ROBOT_SUPP`,
					`COMPONENT_AT_M416_SUPP`,
					`COMPONENT_AT_M416ELECTRO_SUPP`,
					`COMPONENT_AT_M490_SUPP`,
					`COMPONENT_AT_MAGMA_SUPP`,
					`COMPONENT_AT_PPKPISTOL_SUPP`,
					`COMPONENT_AT_SAMURAI_SUPP`,
					`COMPONENT_AT_SCARLP_SUPP`,
					`COMPONENT_AT_SNAKEUZI_SUPP`,
					`COMPONENT_AT_USP_SUPP`,
					`COMPONENT_AT_USPS_SUPP`,
					`COMPONENT_AT_WHITECODE_SUPP`,
					`COMPONENT_AT_YELDRAGON_SUPP`,
				},
				usetime = 2500
			}
		},
		...
		['at_clip_extended_pistol'] = {
			...
			client = {
				...
				component = {
					...
					`COMPONENT_PPKPISTOL_CLIP_02`,
					`COMPONENT_USP_CLIP_02`,
					`COMPONENT_GOLDSTONE_CLIP_02`,
					`COMPONENT_GLORY_CLIP_02`,
					`COMPONENT_GUZI_CLIP_02`,
					`COMPONENT_PISTOL_CLIP_03`,
					`COMPONENT_PISTOL_CLIP_04`,
				},
				usetime = 2500
			}
		},
		...
		['at_clip_extended_rifle'] = {
			...
			client = {
				...
				component = {
					...
					`COMPONENT_AKSPIDER_CLIP_02`,
					`COMPONENT_ASHBRINGER_CLIP_02`,
					`COMPONENT_AUG_CLIP_02`,
					`COMPONENT_M14_CLIP_02`,
					`COMPONENT_M16ROBOT_CLIP_02`,
					`COMPONENT_M416_CLIP_02`,
					`COMPONENT_M416ELECTRO_CLIP_02`,
					`COMPONENT_MAGMA_CLIP_02`,
					`COMPONENT_SCARLP_CLIP_02`,
					`COMPONENT_WHITECODE_CLIP_02`,
				},
				usetime = 2500
			}
		},
		...
		['at_clip_extended_sniper'] = {
			...
			client = {
				...
				component = {
					...
					`COMPONENT_AWPICE_CLIP_02`,
					`COMPONENT_AZUROK_CLIP_02`,
					`COMPONENT_BLDRAGON_CLIP_02`,
					`COMPONENT_YELDRAGON_CLIP_02`,
				},
				usetime = 2500
			}
		},
		...
		['at_scope_medium'] = {
			...
			client = {
				component = {
					...
					`COMPONENT_AT_ASHBRINGER_MEDIUM`,
					`COMPONENT_AT_WHITECODE_MEDIUM`,
				},
				usetime = 2500
			}
		},
		...
		['at_scope_advanced'] = {
			...
			client = {
				component = {
					...
					`COMPONENT_AT_AWPICE_MAX`,
					`COMPONENT_AT_AZUROK_MAX`,
					`COMPONENT_AT_BLDRAGON_MAX`,
					`COMPONENT_AT_DEADFALL_MAX`,
					`COMPONENT_AT_M14_MAX`,
					`COMPONENT_AT_YELDRAGON_MAX`,
				},
				usetime = 2500
			}
		},
