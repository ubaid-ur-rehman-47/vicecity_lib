require "sprites.modules.textures"
local sprites = require "sprites.modules.sprites"
local config = require "sprites.modules.config"
local CreateSprite = require "sprites.modules.sprite"
local myPed = nil
...
local function spriteOnEntity(data)
    return CreateSprite:defineSpriteOnEntity(data)
end
Sprites.spriteOnEntity = spriteOnEntity

local function getClosestSprite()
    return CreateSprite:getClosestSprite()
end
Sprites.getClosestSprite = getClosestSprite

local function spriteOnBone(data)
    return CreateSprite:defineSpriteOnBone(data)
end
Sprites.spriteOnBone = spriteOnBone

local function sprite(data)
    return CreateSprite:defineSprite(data)
end
Sprites.sprite = sprite
exports('sprite', sprite)

local function updateTargetData(id, key, value)
...
Sprites.updateTargetData = updateTargetData

RegisterCommand('testt', function ()

local test = Sprites.sprite({
